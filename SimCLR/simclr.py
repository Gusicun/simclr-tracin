    ...
    def train(self, train_loader):#pretrain
        ...
        for epoch_counter in range(self.args.epochs):#2
            ...
            for images, _ in tqdm(train_loader):#batch=256,512
                ...
                if epoch_counter !=0:
                    if tracin_scores>0:
                    #if tracin_scores>batch_score[epoch_counter-1][n_iter]:
                        print('just upgrad')
                ...
                if epoch_counter==0:
                    if n_iter % self.args.log_every_n_steps == 0:
                        ...
                        save_checkpoint({
                            ...
                            'acc/top1':top1[0],
                            'acc/top5':top5[0]
                        }, is_best=False, filename='D:/tracin-main/positive/'+checkpoint_name)
                    ...
                    if tracin_scores >=0 :
                        ...
                        save_checkpoint({
                            ...
                            'acc/top1':top1[0],
                            'acc/top5':top5[0]
                        }, is_best=False, filename='D:/tracin-main/negative/'+checkpoint_name)
                        print('this checkpoint is about {}epoch and {}step'.format(epoch_counter,n_iter))
                n_iter += 1
        ...
        checkpoint_name = 'checkpoint_{:04d}_{}.pth.tar'.format(self.args.epochs,self.args.step)
        save_checkpoint({
            'epoch': self.args.epochs,
            'arch': self.args.arch,
            'state_dict': self.model.state_dict(),
