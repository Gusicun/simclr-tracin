    ...
    def train(self, train_loader):#pretrain
        ...
        for epoch_counter in range(self.args.epochs):#2
            ...
            for images, _ in tqdm(train_loader):#batch=256,512
                #print(type(images))
                if epoch_counter % 8 ==0:
                    images = torch.cat(images, dim=0)
                    print('--------------Train epoch for tracin______________________________')
                    images = images.to(self.args.device)
                    with autocast(enabled=self.args.fp16_precision):
                    ...
                    scaler.update()
                    print('this is batch {} for tracin'.format(n_iter))
                    ...
                    #print('Top 40 in epoch 1 is:{}'.format(random_list))
            ...
            save_checkpoint({
                ...
                'acc/top1':top1[0],
                'acc/top5':top5[0]
            }, is_best=False, filename='D:/tracin-main/bottom20/'+checkpoint_name)
